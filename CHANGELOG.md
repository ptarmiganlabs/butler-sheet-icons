...
* Add vulnerability scanning as part of each release ([2a57fa5](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/2a57fa5da393c54f0e65be0bed904ed346e3a04d)), closes [#150](https://github.com/ptarmiganlabs/butler-sheet-icons/issues/150)
...
* add Docker build action ([0b8ac63](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/0b8ac638895f34ae407f0654eebe02db18434a6e))
...
* Add testing for multiple Node.js versions on MacOS ([ec40531](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/ec40531e4fb3c8bdfd461a114f76bc2842b92015))
...
* Broken Docker builds ([#33](https://github.com/ptarmiganlabs/butler-sheet-icons/issues/33)) ([e10edcd](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/e10edcdffbe1327f9a82eb9288cb0f84e89cf4a6))
* Broken release process ([6a9b31a](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/6a9b31a8c93a6c7928e4366b3be1975735e4e811))
* Broken release process ([#33](https://github.com/ptarmiganlabs/butler-sheet-icons/issues/33)) ([0df73f6](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/0df73f6ecc57b1058f3731bfaeb33b9372a9669b))
* CI debug ([7794d4f](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/7794d4fff36bf8ac532e9611b82a014fc0eab049))
* CI tweaking ([7856b4d](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/7856b4d59ed07adde388f924de9f521fc318f92f))
...
* **ci:** Increase timeout for CI tests to 5 min ([db0284b](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/db0284bf12f3d526eba02b431b5bae518286011f))
* config docker build ([3107675](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/310767569544f02ac4f3fb4be52566f9f3b88a5b))
* config Docker image build action ([c1f5d7e](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/c1f5d7ef6570198b2da39eb57fecaa47178566ef))
...
* Debug Docker image building ([1231368](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/12313685c9c1ae26f92d66343accc56b6e5104a1))
...
* Dociker image build ([e0c8a11](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/e0c8a11789badc1a4f8ae0e449325c96629f6f39))
* Docker image builds ([#13](https://github.com/ptarmiganlabs/butler-sheet-icons/issues/13)) ([44b2257](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/44b2257c7486f30117651bf5378138ae6ac97730))
...
* Incorrect release PR subject ([7dca0b8](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/7dca0b8288a7fcb0dd5b10b54b3f8feb2fe1b813))
...
* remove actions for debugging ([5da0ecb](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/5da0ecbda9c581544c091eb3f4b8086990e381f3))
* set up release-please ([52aa020](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/52aa0201a68912022ce60ed48d3695eca633a54e))
* Slim down release ZIPs ([445d227](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/445d227b544a8d0fd964d2115c13481c72c1d70a))
...
* Testing on macOS ([7ee66b8](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/7ee66b8e396c9b7f3b3a843f90350a8f7ac5686e))
...
* Update dependencies ([ef38b7d](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/ef38b7d159547077c670eb661063edbfc0ac85a2))
...
* add missing section numbering ([2f96aef](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/2f96aef621880108540791922b914516a919ebd4))
* Add more sections to release notes ([dcd8bac](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/dcd8bacbd4de1222983e6481d33601a26ef7541b))
* add section on testing ([80deef7](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/80deef749cb659bf8591ee57b275bee720d71fbd))
* cleanup of readme file ([c92043f](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/c92043f7a086ce32f1996dd224ac72d569712b54))
* comment on using Sense's bundled Node version ([e187f5e](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/e187f5e9544da75c29f2a22243dcd572d922e2ab))
...
* fix badge icon images ([b440cf1](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/b440cf1aaeae31efbf432c2956ad3823fb8226ff))
* Fix broken CI badge in readme file ([2ea5d07](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/2ea5d0728df009b992e9370465f52e5df886115b))
* Fix typo ([d273ece](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/d273ecef3cd5e5fcd57f950c4d24bf51aea8d9be))
* Fix typo ([6ca7a54](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/6ca7a5494ea26be4e6f1b5d8b4903d61a6de260c))
* fix typos ([e135848](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/e135848b65c4e1d4457a530988fa89f074bd2ee7))
* improve build status badges ([7e11849](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/7e11849fb64b1ee3b10701cd95bbf8aedba8094f))
* Minor Docker update ([debc725](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/debc72503685e92727b8e9fa747eb601124c1ee2))
...
* remove intro disclaimer ([368a1d5](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/368a1d5516e5a792d2c029a33120ed7a4b0edd10))
* remove manual changelog file ([67a3c3c](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/67a3c3cad9894f9626c513b4692dfbba247dd406))
...
* Update wrt 1.1.5 ([0058999](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/0058999a6a360e098ad6f5ab514767783fc94395))
* Updated README wrt Docker usage ([eb25ed0](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/eb25ed03550347cfcc184ea1e45b450d0a989095))
...
* **deps:** update actions/checkout action to v2 ([77039e9](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/77039e98a87f72380d50ba4b5de3c65a23642e91))
* **deps:** update actions/checkout action to v3 ([1a7ca03](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/1a7ca035c122137e88209741dc46e925a357d667))
* **deps:** update actions/download-artifact action to v3 ([5b9f5e2](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/5b9f5e26f6aa5b5d1ed3f5c3a7f42fa88eaddaf8))
* **deps:** update actions/setup-node action to v3 ([77cb11e](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/77cb11e45f7691778128d3742d7373246dc34a47))
* **deps:** update actions/upload-artifact action to v3 ([bc21e98](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/bc21e98b0c846eb057959c9d23b627d4df46ef5d))
...
* **deps:** update googlecloudplatform/release-please-action action to v2.32.0 ([2aeba90](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/2aeba903b400ceb66f90d35e6d4a299e23ef6f74))
* **deps:** update googlecloudplatform/release-please-action action to v2.33.0 ([b1c5503](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/b1c55035b6db479a44e446f219cc25d089be9d91))
* **deps:** update googlecloudplatform/release-please-action action to v2.33.1 ([ba2540b](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/ba2540bb03a2bd5ea596e5932dbca801e4dec52f))
* **deps:** update googlecloudplatform/release-please-action action to v3 ([be158b8](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/be158b8123babdb0fe8a35f54979a7347a2967b9))
...
* Refine CI ([4de39ee](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/4de39ee112699a75e36a570063b9b6bed0ab777d))
...
* Release 1.0.4 ([a45e59e](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/a45e59e6dabc6e4e57efcb176d7ce019ada2f925))
* release 1.1.0 ([c5fc53d](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/c5fc53d487b4f0f5cd77421b4df3133a4401fdca))
...
* Update release-please version ([e6868ae](https://github.com/ptarmiganlabs/butler-sheet-icons/commit/e6868aea3f58a1a2c8550a0b666db786f769d5fc))
